...
public class SesionesEntrenamientoController {
   ...
   void initialize() {
      ...
      ObservableList<Miembro> miembros = FXCollections.observableArrayList(club.administrador.getListaMiembros());
      miembro_comboBox.setItems(miembros);

      ObservableList<Entrenador> entrenadores = FXCollections.observableArrayList(club.administrador.getEntrenadores());
